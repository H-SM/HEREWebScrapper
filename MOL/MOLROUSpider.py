...
class MolrouspiderSpider(scrapy.Spider):
    ...
    # start_urls = ["https://molromania.ro/ro/"]

    base_url = "https://cautarestatii.molromania.ro/hu/portlet/routing/"
    ...
    def parse(self, response):
        ...
        for store in store_list:
            ...
            # Check if country_id is "10" - Romania POI's only
            if country_id == "10":
                body = {"id": store_id}
                yield scrapy.FormRequest(
    ...
    def parse_store_details(self, response):
        ...
        mappedAttributes = {
            ...
            "website": "https://molromania.ro/ro/",
            "lat": store_data["lat"],
            "lon": store_data["lng"],
        }
